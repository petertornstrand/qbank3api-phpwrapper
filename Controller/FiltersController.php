...
class FiltersController extends ControllerAbstract
{
	 ...
	 * @return FilterItem[]
	 */
	public function freetext($freetext, $deploymentSiteIds = null, $mode = self::FREETEXT_OR, CachePolicy $cachePolicy = null)
	{
		$parameters = [
			'query'   => ['deploymentSiteIds' => $deploymentSiteIds, 'mode' => $mode],
			'body'    => json_encode([]),
			'headers' => [],
		];
